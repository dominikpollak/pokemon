  ...
  return (
    ...
    >
          ...
          <div className="flex justify-around border-y-[1px] my-2 py-4">
            ...
            <div
              className={
                pokemon.types.length > 1
                  ? 'border-r-[1px] pr-4 pl-2 py-2 text-[0.9em] lg:text-lg'
                  : 'border-r-[1px] pr-7 py-2'
              }
            >
            ...
            <div className="py-2 pl-1 ">
              <div
                className={
                  pokemon.types.length > 1
                    ? 'inline-block text-[0.9em] lg:text-[1.1em]'
                    : 'inline-block text-[0.9em] lg:text-lg'
                }
              >
                {pokemon.types && (
      ...
      <footer className="text-center pb-8">
        <Link className="hover:font-semibold text-lg" href="/">
          back
        </Link>
      </footer>
    </div>
