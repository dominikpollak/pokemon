...
export default function PokemonList({ pokesWithId, query}) {
  ...
  return (
      <div className="grid grid-cols-3 sm:grid-cols-5 lg:grid-cols-4 px-8 lg:px-[8em] pb-24 pt-12">
      ...
      cursor-pointer capitalize text-md text-center text-[0.8em] lg:text-[1.2em] shadow-md m-1 duration-150
